import { Mail, GraduationCap, Calendar, Target, Settings as SettingsIcon, Lock, Palette, Bell, Shield, LogOut, ChevronRight } from 'lucide-react'
      ...
      <div className="profile-page-card">
        ...
        <div className="profile-page-settings-list">
          {settingsSections.map((section) => {
            ...
            return (
              <button key={section.title} className="profile-page-settings-item">
                ...
                <ChevronRight size={16} className="profile-page-settings-arrow" />
              </button>
            )
          })}
        </div>
